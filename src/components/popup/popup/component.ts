...
export default class VueMappPopup extends Vue {
    ...
    @Prop([String, Boolean]) fillTrigger: string | boolean;
    @Prop([String, Boolean]) floatTrigger: string | boolean;
    @Prop([String, Boolean]) showArrow: string | boolean;
    @Prop([String, Boolean]) closeOnClick: string | boolean;
